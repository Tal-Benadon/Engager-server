  ...
  let objCamp = {
    ...
    msg: [
      ...
      },
      {
        subject: "יום פתוח",
        content:
          "יום פתוח, יתקיים ביום שישי, 1.3.24, בשעה 09:30 בבוקר.            תוכלו להירשם דרך טופס ההרשמה (עכשיו הירשמו) הנמצא בכל דפי האתר.",
      ...
      },
      {
        ...
        content:
          "הזדמנות אחרונה להירשם! קורס עיצוב תיק דוקטור עם אלה עלוש ⏰משך הקורס: 6 מפגשים בני 4 שעות. ⏳תאריך פתיחה: 19/1 ימים ושעות: ימי חמישי",
  ...
  let objCamp2 = {
    ...
    msg: [
      ...
      },
      {
        ...
        content:
          "אנחנו אוהבים תמונות ואנשים, יש לנו ניסיון עשיר בהדפסת תמונות על מגוון רעיונות ועיצובים, יש לנו מגוון רחב של מתנות עם תמונה לאוהבים שלכם, או לעצמכם, טיילו באתר ותהנו. ",
